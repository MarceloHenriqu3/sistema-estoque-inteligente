...
public static class InventoryForecast
{
    public static async Task<ForecastResult> ForecastDailyOutflowAsync(int productId, InventoryContext db)
    {
        ...
        var pipeline = mlContext.Transforms.Concatenate("Features", nameof(DemandObservation.DayOfWeek), nameof(DemandObservation.DayOfMonth), nameof(DemandObservation.Month), nameof(DemandObservation.PreviousWeekAvg), nameof(DemandObservation.Quantity), nameof(DemandObservation.MinQuantity))
